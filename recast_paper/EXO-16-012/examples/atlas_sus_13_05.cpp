...
#include "SampleAnalyzer/User/Analyzer/atlas_sus_13_05.h"
...
// -----------------------------------------------------------------------------
bool atlas_sus_13_05::Initialize(const MA5::Configuration& cfg,
...
// -----------------------------------------------------------------------------
void atlas_sus_13_05::Finalize(const SampleFormat& summary,
...
// -----------------------------------------------------------------------------
bool atlas_sus_13_05::Execute(SampleFormat& sample, const EventFormat& event)
{
  if (event.rec()!=0)
  {
    ...
    if(NumBJets == 2)
    {
    TLorentzVector BJetsSum = SignalBJets[0]->momentum() +

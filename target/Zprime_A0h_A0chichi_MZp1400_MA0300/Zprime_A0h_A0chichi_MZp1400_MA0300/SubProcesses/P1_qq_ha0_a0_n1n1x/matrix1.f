...
C     
C     Process: u u~ > zp > h a0 WEIGHTED<=4 @1
C     *   Decay: a0 > n1 n1~ WEIGHTED<=2
C     Process: c c~ > zp > h a0 WEIGHTED<=4 @1
C     *   Decay: a0 > n1 n1~ WEIGHTED<=2
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
...
C     ----------
      ...
      CALL OXXXXX(P(0,4),MDL_MX,NHEL(4),+1*IC(4),W(1,4))
      CALL IXXXXX(P(0,5),MDL_MX,NHEL(5),-1*IC(5),W(1,5))
      CALL FFS1_3(W(1,5),W(1,4),GC_9,MDL_MA0,MDL_WA0,W(1,6))
      CALL FFV2_3_6_3(W(1,1),W(1,2),GC_51,GC_10,GC_57,MDL_MZP,MDL_WZP
     $ ,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL VSS1_0(W(1,5),W(1,6),W(1,3),GC_71,AMP(1))
